                ...
                >
                    ...
                    >
                        <input
                            ...
                            className="flex-1 bg-zinc-900/50 border border-zinc-800 rounded-full px-6 py-4 text-white placeholder-zinc-500 focus:outline-none focus:border-[#A16EFF] focus-visible:ring-2 focus-visible:ring-[#A16EFF] focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900 transition-colors font-manrope disabled:opacity-50 disabled:cursor-not-allowed"
                        />
                        <motion.button
                            type="submit"
                            disabled={status === "submitting" || status === "success"}
                            className="font-urbanist font-bold text-zinc-900 bg-gradient-to-r from-[#A16EFF] via-[#60F9B8] to-[#00B8FF] px-8 py-4 rounded-full shadow-lg whitespace-nowrap transition-text duration-300 disabled:opacity-75 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A16EFF] focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
